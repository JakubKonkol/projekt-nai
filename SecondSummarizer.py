...
class SecondSummarizer:
    def __init__(self, model_name="pszemraj/led-base-book-summary", min_length=8, max_length=30, no_repeat_ngram_size=3, encoder_no_repeat_ngram_size=3, repetition_penalty=3.5, num_beams=4, do_sample=False, early_stopping=True):
